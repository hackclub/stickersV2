				...
				<a href="/profile" class="profile-info">
					...
					<div class="profile-text">
						<span class="profile-name"
							>{data.user.nickname ?? data.user.first_name ?? 'profile'}</span
						>
