			...
			<div class="dashboard-row">
				<a class="dashboard-link" href={home}
					>go to dashboard <svg
						...
						fill="currentColor"
						width="clamp(1.75rem, 2vw, 4.5rem)"
						height="clamp(1.75rem, 2vw, 4.5rem)"
						><path
